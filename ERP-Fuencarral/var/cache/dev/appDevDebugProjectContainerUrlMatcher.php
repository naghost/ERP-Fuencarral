...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // fabricacion_homepage
        if ('' === $trimmedPathinfo) {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'fabricacion_homepage');
            }

            return array (  '_controller' => 'FabricacionBundle\\Controller\\DefaultController::indexAction',  '_route' => 'fabricacion_homepage',);
        }
        ...
        if (0 === strpos($pathinfo, '/Inventario')) {
            // inventario_homepage
            if ('/Inventario/Producto' === $pathinfo) {
                return array (  '_controller' => 'InventarioBundle\\Controller\\DefaultController::indexAction',  '_route' => 'inventario_homepage',);
            }

            // Proveedor_homepage
            if ('/Inventario/Proveedor' === $pathinfo) {
                return array (  '_controller' => 'InventarioBundle\\Controller\\DefaultController::proveedorAction',  '_route' => 'Proveedor_homepage',);
            }

            // Almacen_homepage
            if ('/Inventario/Almacen' === $pathinfo) {
                return array (  '_controller' => 'InventarioBundle\\Controller\\DefaultController::almacenAction',  '_route' => 'Almacen_homepage',);
            }

            // ver_homepage
            if ('/Inventario/ver' === $pathinfo) {
                return array (  '_controller' => 'InventarioBundle\\Controller\\DefaultController::verAction',  '_route' => 'ver_homepage',);
            }
